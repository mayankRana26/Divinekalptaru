        ...
        <div className="flex flex-col gap-12 md:flex-row items-start md:space-x-12">
          ...
          <motion.div className="md:w-1/2 space-y-6" variants={sectionVariants}>
            <p className="text-lg leading-relaxed text-gray-700">
              🕉️ Welcome to Your Sanctuary of Inner Harmony. You will have
              access to all the facilities you could possibly need in our
              peaceful campus in Bengaluru. The ambiance is meticulously
              designed for immersive practice, making it a genuinely inspiring
              place that fosters deep spiritual well-being. 🌿
            </p>

            <p className="text-lg leading-relaxed text-gray-700">
              Under the gentle guidance of our experienced yoga masters, you’ll
              explore the true essence of yoga — blending ancient traditions
              with modern insights. Every session is designed to elevate your
              awareness and bring lasting inner peace.
            </p>

            <p className="text-lg leading-relaxed text-gray-700">
              Whether you are a beginner discovering the beauty of yoga or an
              advanced practitioner refining your mastery, oupersonalized approa
              nurtures growth at every step. The serene surroundings and
              holistic routines cultivate an environment of complete
              rejuvenation—mind, body, and soul. 🧘‍♀️💫
            </p>
          </motion.div>
        </div>
      </div>
